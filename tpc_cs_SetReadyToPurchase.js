 ...
 define(['N/currentRecord', 'N/https'], function (currentRecord, https) {
    ...
    function pageInit(context) {
        try {
            ...
            log.debug("So Id from client script: ",soId)
            ...
            var activitycode = urlParams.get('custpage_so_activitycode')
            ...
            if (activitycode) record.setValue({fieldId: "custpage_so_activitycode",value: activitycode})
    ...
    function reloadWithFilters() {
        try {
            ...
            var activitycode = record.getValue({ fieldId: "custpage_so_activitycode"})
            ...
            window.location.href = baseUrl + '&deploy=1&custpage_customer=' + customerId 
                + '&custpage_so_id=' + soId
                ...
                + '&custpage_so_activitycode=' + encodeURIComponent( activitycode || '')
        } catch (error) {
